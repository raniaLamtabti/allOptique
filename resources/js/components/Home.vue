        ...
        <div class="banner">
            <div class="left">
                <div class="content">
                    ...
                    <div class="social">
                        <a href=""
                            ><img :src="'/iconsLogo/socialFb.png'" alt=""
                        /></a>
                        <a href=""
                            ><img :src="'/iconsLogo/socialIg.png'" alt=""
                        /></a>
                        <a href=""
                            ><img :src="'/iconsLogo/socialPhone.png'" alt=""
                        /></a>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <router-link class="link" v-for="kid in kids" :to="'product/'+ kid.id ">
                    <product-component
                        ...
                        v-bind:description="kid.description"
                        v-bind:price="kid.price"
                    ></product-component>
                </router-link>
            </div>
        </div>
                ...
                <div class="products">
                    <router-link class="link" v-for="women in womens" :to="'product/'+ women.id ">
                        <product-component
                            ...
                            v-bind:description="women.description"
                            v-bind:price="women.price"
                        ></product-component>
                    </router-link>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getProductKid() {
            axios.get("/productKid").then(response => {
                this.kids = response.data;
            });
        },
        getProductWomen() {
            axios.get("/productWomen").then(response => {
                this.womens = response.data;
            });
        },
        getMarque() {
            axios.get("/marqueList").then(response => {
